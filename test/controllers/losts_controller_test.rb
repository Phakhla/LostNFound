...
class LostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lost" do
    assert_difference("Lost.count") do
      post losts_url, params: { lost: { date: @lost.date, detail: @lost.detail, location: @lost.location, name: @lost.name, reward: @lost.reward, time: @lost.time, types: @lost.types } }
    end
  ...
  test "should update lost" do
    patch lost_url(@lost), params: { lost: { date: @lost.date, detail: @lost.detail, location: @lost.location, name: @lost.name, reward: @lost.reward, time: @lost.time, types: @lost.types } }
